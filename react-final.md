...
* Feature-based vs Atomic Design folder structures
	* Feature-based — group by feature (e.g., `src/features/profile/...`): keeps all feature code together.
	* Atomic — group by component scale (atoms → molecules → organisms): ideal for design systems and reuse.
